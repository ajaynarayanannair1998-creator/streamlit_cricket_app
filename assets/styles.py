...
def set_background(image_path: str):
    """Full-page background image that auto-pans top-to-bottom-to-top continuously."""
...
def home_styles():
    st.markdown(
        """
        <style>
        @import url('https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;800&family=Sora:wght@700;800&display=swap');
        ...
        .home-feat-points { list-style: none; padding: 0; margin: 0; }
        .home-feat-points li {
