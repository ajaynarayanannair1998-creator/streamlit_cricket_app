...
def stadium_data():
    ...
    selected_stadium = st.selectbox("Select Stadium", ["Select your stadium"]+["All stadiums Analysis"] + valid_stadiums)
    data = df.copy() if selected_stadium == "All stadiums Analysis" else df[df["city"] == selected_stadium].copy()
    
    if selected_stadium=='Select your stadium':
        st.stop()
